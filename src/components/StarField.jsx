export default function StarField({ soft = false, fixed = false }) {
  return (
    <div className={`pointer-events-none inset-0 overflow-hidden ${fixed ? "fixed" : "absolute"}`}>
      ...
      <div className={`stars-layer stars-layer-three ${soft ? "opacity-20" : "opacity-50"}`} />
      <div className="bright-star left-[12%] top-[16%]" />
      <div className="bright-star bright-star-pink right-[18%] top-[24%]" />
      <div className="bright-star bright-star-teal left-[28%] bottom-[22%]" />
      <div className="bright-star right-[34%] bottom-[18%]" />
